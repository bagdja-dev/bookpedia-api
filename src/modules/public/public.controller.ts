...
export class PublicController {
  ...
  @ApiOperation({
    ...
    description:
      'HANYA Book dengan minimal 1 Chapter berstatus published yang muncul. search filter judul (ILIKE), genre exact match. page default 1, limit default 20 (max 50).',
  })
